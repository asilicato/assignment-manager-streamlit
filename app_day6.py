...
if json_path_assignment.exists():
    with open(json_path_assignment, "r", encoding="utf-8") as f:
...
if st.session_state["role"]== "Admin":
    ...
    if st.session_state["page"]== "home":
        st.markdown("Welcome (st.session_state['user']['email']) to your dashboard")
        if st.button("Go to Dashboard", types="primary", key="view_dash_btn"):
